...
This document describes the JSON format used for FieryMUD world files. These files are generated by the `scripts/world_to_json.py` script and stored in `data/world/` directory.
