...
extern int parse_class(char_data *ch, char_data *vict, char *arg);
extern int getbaseclass(int class_num);
extern void init_char_class(char_data *ch);
extern void update_char_class(char_data *ch);
extern void advance_level(char_data *ch, enum level_action);
extern void convert_class(char_data *ch, int newclass);
extern int return_max_skill(char_data *ch, int skill);
extern void give_newbie_eq(char_data *vict);
