/***************************************************************************
 *   File: tests/test_server_resilience.cpp           Part of FieryMUD *
 *  Usage: Integration tests for server resilience and error handling    *
 ***************************************************************************/
...
TEST_CASE("Server Resilience: Command System", "[server][resilience][integration]") {
