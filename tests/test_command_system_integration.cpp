/***************************************************************************
 *   File: tests/test_command_system_integration.cpp  Part of FieryMUD *
 *  Usage: Integration tests for the command system                       *
 *************************************************************************/
...
#include "../src/modern/commands/command_parser.hpp" // Added for CommandParser tests
#include "../src/modern/core/ids.hpp"

// Command system integration test (from test_enhanced_integration.cpp)
TEST_CASE("Command System - Full Integration", "[integration][commands]") {
...
// Command Parser Integration - Basic Parsing (from test_command_integration.cpp)
TEST_CASE("Command Parser Integration - Basic Parsing", "[command][parser][integration]") {
...
// Command System Utilities - Basic Functionality (from test_command_integration.cpp)
TEST_CASE("Command System Utilities - Basic Functionality", "[command][utils][integration]") {
...
// ParsedCommand - Argument Handling (from test_command_integration.cpp)
TEST_CASE("ParsedCommand - Argument Handling", "[command][parsed][integration]") {
    ParsedCommand cmd;
    cmd.command = "test";
...
// Command Context - Basic Functionality (from test_command_integration.cpp)
TEST_CASE("Command Context - Basic Functionality", "[command][context][integration]") {
...
// Command Context - Message Routing (from test_gmcp_and_emotes.cpp)
TEST_CASE("Command Context - Message Routing", "[unit][commands]") {
