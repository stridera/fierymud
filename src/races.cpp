...
RaceDef races[NUM_RACES] = {
    ...
    /* FAERIE - UNSEELIE */
    {
        ...
        "&b&9U&0&5ns&b&9ee&0&5li&b&9e F&0&5aeri&9&be&0", /* name as displayed in show race command and when setting
                                                          * races
                                                          */
...
#define ADD_SKILL(s, p)                                                                                                \
    ...
    races[RACE_BROWNIE].effect_flags.set(EFF_INFRAVISION);

    races[RACE_DRAGON_ACID].effect_flags.set(EFF_FLY);
    races[RACE_DRAGON_FIRE].effect_flags.set(EFF_FLY);
    races[RACE_DRAGON_FROST].effect_flags.set(EFF_FLY);
    races[RACE_DRAGON_GAS].effect_flags.set(EFF_FLY);
    races[RACE_DRAGON_LIGHTNING].effect_flags.set(EFF_FLY);
    races[RACE_DRAGON_GENERAL].effect_flags.set(EFF_FLY);

    races[RACE_DRAGONBORN_FIRE].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DRAGONBORN_FROST].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DRAGONBORN_ACID].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DRAGONBORN_LIGHTNING].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DRAGONBORN_GAS].effect_flags.set(EFF_INFRAVISION);

    races[RACE_DROW].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DROW].effect_flags.set(EFF_ULTRAVISION);

    races[RACE_DUERGAR].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DUERGAR].effect_flags.set(EFF_ULTRAVISION);

    races[RACE_DWARF].effect_flags.set(EFF_DETECT_POISON);
    races[RACE_DWARF].effect_flags.set(EFF_INFRAVISION);
    races[RACE_DWARF].effect_flags.set(EFF_ULTRAVISION);

    races[RACE_ELF].effect_flags.set(EFF_INFRAVISION);

    races[RACE_FAERIE_SEELIE].effect_flags.set(EFF_FLY);

    races[RACE_FAERIE_UNSEELIE].effect_flags.set(EFF_FLY);

    races[RACE_GNOME].effect_flags.set(EFF_INFRAVISION);

    races[RACE_HALF_ELF].effect_flags.set(EFF_INFRAVISION);

    races[RACE_HALFLING].effect_flags.set(EFF_INFRAVISION);
    races[RACE_HALFLING].effect_flags.set(EFF_SENSE_LIFE);

    races[RACE_OGRE].effect_flags.set(EFF_INFRAVISION);
    races[RACE_OGRE].effect_flags.set(EFF_ULTRAVISION);

    races[RACE_SVERFNEBLIN].effect_flags.set(EFF_INFRAVISION);
    races[RACE_SVERFNEBLIN].effect_flags.set(EFF_ULTRAVISION);

    races[RACE_TROLL].effect_flags.set(EFF_INFRAVISION);
    races[RACE_TROLL].effect_flags.set(EFF_ULTRAVISION);
...
void update_char_race(CharData *ch) {
    ...
    EFF_FLAGS(ch) = races[(int)GET_RACE(ch)].effect_flags;
}
