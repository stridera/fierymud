 ...
 * Updated define for curse to allow for cursing of in_room objects as well as
 *updated remove curse to look at the spell_remove_curse function (much more
 *handy dandy!)
 *
 ...
 * Removed dispel magic, greater_firewalk, firewalk, circle of fire from spell
 *defines
 *
 ...
 * Added weapon proficiency skills for stabbing, piercing, bludgeoning and two
 *handed of each of these, as well as missile weapons.  These were given to all
 *classes at first level execpt missile weapons which was commented out for now.
 *
 ...
 * added a check in update_casting to stop players who were saved in the casting
 *state just before a crash.  Such players would get into an endless casting
 *loop and crash the mud.
 *
 * -gurlaek
 *
 ...
 * Working on quest spells.  Still in progress.  HOwever, spells[] array now has
 *a flag quest.  If it's true then it's considerd a quest spell.  Also, allowed
 *pyro/cryo's to learn from any sorcerer type teacher fingon l.
 *
