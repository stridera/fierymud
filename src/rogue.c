...
/* Bard spell lists */
const struct spell_pair mob_bard_buffs[] = {{SPELL_DETECT_INVIS, 0, EFF_DETECT_INVIS},
...
const int mob_bard_offensives[] = {
    SPELL_VICIOUS_MOCKERY,  SPELL_HARM,             SPELL_SHOCKING_GRASP,   SPELL_CAUSE_CRITIC,
    SPELL_CHILL_TOUCH,      SPELL_CAUSE_SERIOUS,    SPELL_BURNING_HANDS,    SPELL_MAGIC_MISSILE,
    SPELL_CAUSE_LIGHT,      0};
