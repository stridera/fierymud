...
const std::unordered_map<PlayerFlag, std::string> player_flag_names = {
    ...
    {PlayerFlag::NoRepeat, "NO_REPEAT"},
    {PlayerFlag::AutoLoot, "AUTO_LOOT"},
    {PlayerFlag::AutoGold, "AUTO_GOLD"},
    {PlayerFlag::AutoSplit, "AUTO_SPLIT"},
    {PlayerFlag::AutoExit, "AUTO_EXIT"},
    {PlayerFlag::AutoAssist, "AUTO_ASSIST"},
    {PlayerFlag::Wimpy, "WIMPY"},
    {PlayerFlag::ShowDiceRolls, "SHOW_DICE_ROLLS"},
    {PlayerFlag::Afk, "AFK"},
    {PlayerFlag::Deaf, "DEAF"},
    {PlayerFlag::NoTell, "NO_TELL"},
    {PlayerFlag::NoSummon, "NO_SUMMON"},
    {PlayerFlag::Quest, "QUEST"},
    {PlayerFlag::PkEnabled, "PK_ENABLED"},
    {PlayerFlag::Consent, "CONSENT"},
    {PlayerFlag::ColorBlind, "COLOR_BLIND"},
    {PlayerFlag::Msp, "MSP"},
    {PlayerFlag::MxpEnabled, "MXP_ENABLED"},
    {PlayerFlag::HolyLight, "HOLY_LIGHT"},
    {PlayerFlag::ShowIds, "SHOW_IDS"},
};
