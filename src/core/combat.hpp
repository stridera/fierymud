...
public:
     ...
     */
    static HitCalcResult calculate_hit(const CombatStats& attacker_stats,
     ...
     */
    static double calculate_damage(const Actor& attacker, const CombatStats& attacker_stats,
     ...
     */
    static double apply_mitigation(double raw_damage,
