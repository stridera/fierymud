 ...
 * Added do_abandon (abandon (lists follower), abandon players (abandon all
 *players), abandon pets (abandon all charmies), abandon <player> (abandons a
 *specific player) Note there are slight differences in whether PK is on or off.
 *
 ...
 * Don't allow open/close/lock/unlock of solid objects when you're in a fluid
 *state.
 *
 ...
 * round... also allowed the ability to move while hidden if successfully
 *sneaking.
 *
