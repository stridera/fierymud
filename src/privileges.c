...
static void do_command_grant_revoke(struct char_data *ch, struct char_data *vict, char *argument, int subcmd,
                                    int type) {
...
static void do_flag_grant_revoke(struct char_data *ch, struct char_data *vict, char *argument, int subcmd) {
    int flag;
...
void read_player_grants(FILE *fl, struct grant_type **list) { read_player_grant_list(fl, list, find_command); }
