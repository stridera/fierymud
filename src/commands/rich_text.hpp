/***************************************************************************
 *   File: src/commands/rich_text.hpp                     Part of FieryMUD *
 *  Usage: Rich text formatting system with ANSI colors and styles         *
 *                                                                         *
...
/** Combined text formatting specification */
struct TextFormat {
    ...
    static TextFormat with_color(Color color);
    
    /** Create format with background color */
    static TextFormat with_background(BackgroundColor color);
    
    /** Create format with text style */
    static TextFormat with_style(TextStyle style);
    
    /** Create format with RGB color */
    static TextFormat with_rgb(const ColorRGB& color);
    
    /** Create format with 256-color palette */
    static TextFormat with_256(const Color256& color);
};
...
private:
    ...
    void insert_format(const TextFormat& format);
    void insert_reset();
};
