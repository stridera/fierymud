...
struct SocialMessage {
    ...
    SocialMessage(std::string_view actor_no_arg, std::string_view room_no_arg, std::string_view actor_with_target,
                  std::string_view target_msg, std::string_view room_with_target, std::string_view not_found = "")
        : to_actor_no_arg(actor_no_arg), to_room_no_arg(room_no_arg), to_actor_with_target(actor_with_target),
          to_target(target_msg), to_room_with_target(room_with_target), target_not_found(not_found) {}
};
