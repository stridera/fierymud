/***************************************************************************
 *   File: src/commands/terminal_capabilities.cpp         Part of FieryMUD *
 *  Usage: Terminal capability detection implementation                    *
 *                                                                         *
...
Capabilities detect_capabilities_from_gmcp(const nlohmann::json& client_info) {
    ...
    try {
        ...
        std::string client_lower = caps.client_name;
        std::transform(client_lower.begin(), client_lower.end(), client_lower.begin(), ::tolower);
...
Capabilities get_capabilities_for_terminal(std::string_view terminal_name) {
    ...
    std::string term_lower{terminal_name};
