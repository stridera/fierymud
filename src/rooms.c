...
/*  1 */   { "City",           "&8&b", 1, 5,  100, FALSE, FALSE,      "Ye can't pitch a tent on the sidewalk fool.", "Always lit."},
/*  2 */   { "Field",          "&3",   2, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/*  3 */   { "Forest",         "&2",   3, 10, 125, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/*  4 */   { "Mountains",      "&3",   6, 20, 115, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/*  5 */   { "Shallows",       "&6",   4, 0,  0,   FALSE, TRUE,      "Go buy a floating tent and try again.", ""},
/*  6 */   { "Water",          "&4&b", 2, 0,  0,   FALSE, TRUE,      "Go buy a floating tent and try again.", ""},
/*  7 */   { "Underwater",     "&4",   5, 0,  0,   FALSE, TRUE,      "Go buy a floating tent and try again.", ""},
/*  8 */   { "Air",            "&6&b", 1, 0,  0,   FALSE, FALSE,      "You can't camp in mid-air.", ""},
/*  9 */   { "Road",           "&8",   2, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/* 10 */   { "Grasslands",     "&2&b", 2, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/* 11 */   { "Cave",           "&3&b", 2, 15, 150, TRUE, FALSE,      "(yes, you can camp here)", ""},
/* 12 */   { "Ruins",          "&9&b", 2, 10, 125, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/* 13 */   { "Swamp",          "&2&b", 4, 10, 125, TRUE,  TRUE,      "(yes, you can camp here)", ""},
/* 14 */   { "Beach",          "&3&b", 2, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/* 15 */   { "Underdark",      "&9&b", 2, 10, 125, TRUE,  FALSE,      "(yes, you can camp here)", ""},
/* 16 */   { "Astraplane",     "&6&b", 1, 0,  0,   TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
/* 17 */   { "Airplane",       "&6",   1, 0,  0,   TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
/* 18 */   { "Fireplane",      "&1&b", 1, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
/* 19 */   { "Earthplane",     "&3",   1, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
/* 20 */   { "Etherealplane",  "&5",   1, 5,  100, TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
/* 21 */   { "Avernus",        "&5&b", 1, 0,  0,   TRUE,  FALSE,      "(yes, you can camp here)", "(don't use)"},
};
