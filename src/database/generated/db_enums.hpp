...
inline std::optional<MobFlag> mob_flag_from_db(std::string_view s) {
    static const std::unordered_map<std::string_view, MobFlag> lookup = {
        ...
        {"AGGRO_EVIL_RACE", MobFlag::AggroEvilRace},
        {"AGGRO_GOOD_RACE", MobFlag::AggroGoodRace},
        {"AGGRO_NEUTRAL_RACE", MobFlag::AggroNeutralRace},
        ...
        {"ANIMATED", MobFlag::Animated},
        {"PLAYER_PHANTASM", MobFlag::PlayerPhantasm},
        {"NO_SCRIPT", MobFlag::NoScript},
        {"PET", MobFlag::Pet},
        {"MEDITATE", MobFlag::Meditate},
    };
    auto it = lookup.find(s);
    return it != lookup.end() ? std::optional{it->second} : std::nullopt;
}
...
inline std::string_view mob_flag_to_db(MobFlag e) {
    switch (e) {
        ...
        case MobFlag::AggroEvilRace: return "AGGRO_EVIL_RACE";
        case MobFlag::AggroGoodRace: return "AGGRO_GOOD_RACE";
        case MobFlag::AggroNeutralRace: return "AGGRO_NEUTRAL_RACE";
        ...
        case MobFlag::Animated: return "ANIMATED";
        case MobFlag::PlayerPhantasm: return "PLAYER_PHANTASM";
        case MobFlag::NoScript: return "NO_SCRIPT";
        case MobFlag::Pet: return "PET";
        case MobFlag::Meditate: return "MEDITATE";
    }
    return "";
}
...
inline std::string_view object_flag_to_db(ObjectFlag e) {
    switch (e) {
        ...
        case ObjectFlag::NoTake: return "NO_TAKE";
