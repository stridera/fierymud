...
#define CLANCMD(name)                                                                                                  \
    void(name)(struct char_data * ch, struct clan_membership * member, struct clan * clan, char *argument)
...
static void show_clan_info(struct char_data *ch, const struct clan *clan) {
...
static void show_clan_member_status(struct char_data *ch, const struct char_data *tch) {
