...
constexpr std::array<std::string_view, 3> portal_entry_messages = {
...
constexpr std::array<std::string_view, 8> portal_character_messages = {
    "",
...
constexpr std::array<std::string_view, 4> portal_exit_messages = {
...
/* "okay" etc. */
constexpr std::string_view OK = "Okay.\n";
...
constexpr std::string_view subclass_descrip2 =
...
constexpr std::string_view race_descrip2 =
