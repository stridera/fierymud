...
#define WCMD(name) void(name)(room_data * room, struct trig_data * t, char *argument, int cmd, int subcmd)

struct wld_command_info {
    char *command;
    void (*command_pointer)(room_data *room, struct trig_data *t, char *argument, int cmd, int subcmd);
    int subcmd;
};
