 ...
 * Retired the invstart setting.  It has been replaced by the toggle
 *"autoinvis".
 *
 ...
 * added extra check to avoid crashing mud...dunno why quests is not being
 *nulled though
 *
 ...
 * added listrace...it just prints the choice menu that people have when they
 *start
 *
