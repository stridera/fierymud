/***************************************************************************
 * $Id: fight.c,v 1.283 2012/01/25 18:20:31 mud Exp $
 ***************************************************************************/
/***************************************************************************
...
/***************************************************************************
 * $Log: fight.c,v $
 * Revision 1.283  2012/01/25 18:20:31  mud
 ...
 * Causing set_fighting to take a boolean parameter reciprocate, which indicates
 *that the attackee should also be set fighting, if possible.
 *
 ...
 * Add some stance modifications to prevent loops between alter_hit and
 *update_pos.
 *
 ...
 * No more throwing your primary weapon and winding up with only a secondary.
 *This ought to make me friends with the monk population.
 *
 ...
 * Parry typo corrected. It now outputs the correct verbage when appropriate
 *(i.e. "parries" instead of "parry" for lines such as "Demolitum parries your
 *attack." and "Demolitum parries Kharnez's attack."
 *
 ...
 * moved the obj_to_room() to AFTER the attempt to ref it in the sling out of
 *room.. just in case the next room is a water room and the obj gets
 *extracted...
 *
 ...
 * Fixed crash that happened when a weapon was slung into a room with noone
 *there.
 *
 ...
 * Added stun time associated with slinging a weapon.  Also, a one in five
 *chance will sling the weapon into another room.
 *
