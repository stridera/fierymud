...
void register_exit_bindings(sol::state& lua) {
    ...
    lua.new_usertype<ExitWrapper>("Exit",
        sol::no_constructor,
        ...
        "description", sol::property(&ExitWrapper::description),
        "name", sol::property(&ExitWrapper::name),
        "has_door", sol::property(&ExitWrapper::has_door),
        "is_closed", sol::property(&ExitWrapper::is_closed),
        "is_locked", sol::property(&ExitWrapper::is_locked),
        "is_pickproof", sol::property(&ExitWrapper::is_pickproof),
        "is_hidden", sol::property(&ExitWrapper::is_hidden),
        "is_passable", sol::property(&ExitWrapper::is_passable),
        "destination", sol::property(&ExitWrapper::destination),
        "direction", sol::property(&ExitWrapper::direction),
        "room", sol::property(&ExitWrapper::room),

        // Methods
        "open", &ExitWrapper::open,
        "close", &ExitWrapper::close,
        "lock", &ExitWrapper::lock,
        "unlock", &ExitWrapper::unlock,
        "set_state", &ExitWrapper::set_state,
        "set_destination", &ExitWrapper::set_destination
    );
