...
inline std::optional<TriggerFlag> string_to_trigger_flag(std::string_view str) {
    // Common flags
    if (str == "GLOBAL" || str == "global") return TriggerFlag::GLOBAL;
    if (str == "RANDOM" || str == "random") return TriggerFlag::RANDOM;
    if (str == "COMMAND" || str == "command") return TriggerFlag::COMMAND;
    if (str == "LOAD" || str == "load") return TriggerFlag::LOAD;
    if (str == "CAST" || str == "cast") return TriggerFlag::CAST;
    if (str == "LEAVE" || str == "leave") return TriggerFlag::LEAVE;
    if (str == "TIME" || str == "time") return TriggerFlag::TIME;
    // MOB-specific flags
    if (str == "SPEECH" || str == "speech") return TriggerFlag::SPEECH;
    if (str == "ACT" || str == "act") return TriggerFlag::ACT;
    if (str == "DEATH" || str == "death") return TriggerFlag::DEATH;
    if (str == "GREET" || str == "greet") return TriggerFlag::GREET;
    if (str == "GREET_ALL" || str == "greet_all") return TriggerFlag::GREET_ALL;
    if (str == "ENTRY" || str == "entry") return TriggerFlag::ENTRY;
    if (str == "RECEIVE" || str == "receive") return TriggerFlag::RECEIVE;
    if (str == "FIGHT" || str == "fight") return TriggerFlag::FIGHT;
    if (str == "HIT_PERCENT" || str == "hit_percent") return TriggerFlag::HIT_PERCENT;
    if (str == "BRIBE" || str == "bribe") return TriggerFlag::BRIBE;
    if (str == "MEMORY" || str == "memory") return TriggerFlag::MEMORY;
    if (str == "DOOR" || str == "door") return TriggerFlag::DOOR;
    if (str == "SPEECH_TO" || str == "speech_to") return TriggerFlag::SPEECH_TO;
    if (str == "LOOK" || str == "look") return TriggerFlag::LOOK;
    if (str == "AUTO" || str == "auto") return TriggerFlag::AUTO;
    // OBJECT-specific flags
    if (str == "ATTACK" || str == "attack") return TriggerFlag::ATTACK;
    if (str == "DEFEND" || str == "defend") return TriggerFlag::DEFEND;
    if (str == "TIMER" || str == "timer") return TriggerFlag::TIMER;
    if (str == "GET" || str == "get") return TriggerFlag::GET;
    if (str == "DROP" || str == "drop") return TriggerFlag::DROP;
    if (str == "GIVE" || str == "give") return TriggerFlag::GIVE;
    if (str == "WEAR" || str == "wear") return TriggerFlag::WEAR;
    if (str == "REMOVE" || str == "remove") return TriggerFlag::REMOVE;
    if (str == "USE" || str == "use") return TriggerFlag::USE;
    if (str == "CONSUME" || str == "consume") return TriggerFlag::CONSUME;
    // WORLD-specific flags
    if (str == "RESET" || str == "reset") return TriggerFlag::RESET;
    if (str == "PREENTRY" || str == "preentry") return TriggerFlag::PREENTRY;
    if (str == "POSTENTRY" || str == "postentry") return TriggerFlag::POSTENTRY;
    return std::nullopt;
}
