...
class TriggerManager {
  public:
    ...
    [[nodiscard]] std::vector<TriggerDataPtr> find_triggers(const EntityId &entity_id, ScriptType type,
    ...
    TriggerResult dispatch_command(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor, std::string_view command,
    ...
    TriggerResult dispatch_speech(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor, std::string_view speech);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_greet(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor, Direction from_direction);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_entry(std::shared_ptr<Actor> owner, std::shared_ptr<Room> room, Direction from_direction);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_leave(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor, Direction to_direction);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_receive(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor,
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_bribe(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> actor, int amount);
    ...
    TriggerResult dispatch_death(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> killer);

    /// Execute a FIGHT trigger (combat round)
    /// @param owner The mob in combat
    /// @param opponent The opponent
    /// @return Continue or Halt
    TriggerResult dispatch_fight(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> opponent);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_hit_percent(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> attacker, int hp_percent);

    /// Execute a RANDOM trigger (periodic random chance)
    /// @param owner The mob/object with random trigger
    /// @return Continue
    TriggerResult dispatch_random(std::shared_ptr<Actor> owner);
    ...
    /// @return Continue
    TriggerResult dispatch_load(std::shared_ptr<Actor> owner, std::shared_ptr<Room> room);
    ...
    TriggerResult dispatch_cast(std::shared_ptr<Actor> owner, std::shared_ptr<Actor> caster,
    ...
    /// @return Continue
    TriggerResult dispatch_time(std::shared_ptr<Actor> owner, int hour);
    ...
    /// @return Continue or Halt
    TriggerResult dispatch_attack(std::shared_ptr<Object> weapon, std::shared_ptr<Actor> attacker,
  ...
  private:
    ...
    struct CacheKey {
        ...
        bool operator==(const CacheKey &other) const { return type == other.type && entity_id == other.entity_id; }
    };

    struct CacheKeyHash {
        std::size_t operator()(const CacheKey &key) const {
            std::size_t h1 = std::hash<int>{}(static_cast<int>(key.type));
            std::size_t h2 = std::hash<std::uint64_t>{}((static_cast<std::uint64_t>(key.entity_id.zone_id()) << 32) |
