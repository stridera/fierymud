...
const CommandInfo cmd_info[] = {
    ...
    {"abandon", POS_PRONE, STANCE_RESTING, do_abandon, 0, 0, CMD_MEDITATE},
    {"ack", POS_PRONE, STANCE_RESTING, do_action, 0, 0, 0},
    {"advance", POS_PRONE, STANCE_DEAD, do_advance, LVL_ADMIN, 0, CMD_ANY},
    {"aggr", POS_PRONE, STANCE_DEAD, do_aggr, 0, 0, CMD_MEDITATE | CMD_HIDE},
    ...
    {"ask", POS_PRONE, STANCE_RESTING, do_spec_comm, 0, SCMD_ASK, CMD_OLC | CMD_MEDITATE | CMD_HIDE},
    ...
    {"clan", POS_PRONE, STANCE_SLEEPING, do_clan, 1, 0, CMD_MEDITATE | CMD_HIDE},
    ...
    {"drink", POS_PRONE, STANCE_RESTING, do_drink, 0, SCMD_DRINK, CMD_MEDITATE | CMD_HIDE},
    {"drop", POS_PRONE, STANCE_RESTING, do_drop, 0, SCMD_DROP, CMD_MEDITATE},
    ...
    {"eat", POS_PRONE, STANCE_RESTING, do_eat, 0, SCMD_EAT, CMD_MEDITATE | CMD_HIDE},
    ...
    {"extinguish", POS_PRONE, STANCE_RESTING, do_light, 0, SCMD_EXTINGUISH, CMD_MEDITATE},
    ...
    {"follow", POS_PRONE, STANCE_RESTING, do_follow, 0, SCMD_FOLLOW, CMD_MEDITATE},
    ...
    {"get", POS_PRONE, STANCE_RESTING, do_get, 0, 0, CMD_MEDITATE},
    ...
    {"hold", POS_PRONE, STANCE_RESTING, do_grab, 1, 0, CMD_MEDITATE},
    ...
    {"light", POS_PRONE, STANCE_RESTING, do_light, 0, SCMD_LIGHT, CMD_MEDITATE},
    ...
    {"put", POS_PRONE, STANCE_RESTING, do_put, 0, 0, CMD_MEDITATE},
    ...
    {"quaff", POS_PRONE, STANCE_RESTING, do_use, 0, SCMD_QUAFF, CMD_MEDITATE},
    ...
    {"read", POS_PRONE, STANCE_RESTING, do_read, 0, 0, CMD_MEDITATE | CMD_HIDE},
    ...
    {"recite", POS_PRONE, STANCE_RESTING, do_use, 0, SCMD_RECITE, CMD_MEDITATE},
    {"receive", POS_STANDING, STANCE_ALERT, do_not_here, 1, 0, CMD_NOFIGHT},
    {"recline", POS_PRONE, STANCE_RESTING, do_recline, 0, 0, 0},
    {"remove", POS_PRONE, STANCE_RESTING, do_remove, 0, 0, CMD_MEDITATE},
    ...
    {"say", POS_PRONE, STANCE_RESTING, do_say, 0, 0, CMD_MINOR_PARA | CMD_BOUND | CMD_OLC | CMD_MEDITATE | CMD_HIDE},
    ...
    {"scribe", POS_PRONE, STANCE_RESTING, do_scribe, 0, 0, CMD_MEDITATE},
    ...
    {"wear", POS_PRONE, STANCE_RESTING, do_wear, 0, 0, CMD_MEDITATE},
    ...
    {"wield", POS_PRONE, STANCE_RESTING, do_wield, 0, 0, CMD_MEDITATE},
    ...
    {"write", POS_STANDING, STANCE_ALERT, do_write, 3, 0, CMD_NOFIGHT | CMD_MEDITATE | CMD_HIDE},
