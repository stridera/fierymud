...
WeatherEffects WeatherState::get_effects() const {
    return WeatherUtils::get_default_effects(type, intensity);
}
...
std::string WeatherForecast::describe() const {
    auto confidence_desc = [this]() -> std::string {
        if (confidence >= 0.9f) return "very likely";
        if (confidence >= 0.7f) return "likely";
...
void WeatherSystem::notify_weather_change(EntityId zone_id, const WeatherState& old_state, const WeatherState& new_state) {
...
namespace WeatherUtils {
    ...
    std::string get_weather_color(WeatherType type) {
        switch (type) {
            ...
            case WeatherType::Partly_Cloudy: return "\033[37m"; // White
            case WeatherType::Cloudy: return "\033[90m"; // Dark gray
            case WeatherType::Light_Rain:
            case WeatherType::Heavy_Rain: return "\033[94m"; // Blue
            case WeatherType::Thunderstorm: return "\033[95m"; // Magenta
            case WeatherType::Light_Snow:
            case WeatherType::Heavy_Snow: return "\033[97m"; // Bright white
            case WeatherType::Fog: return "\033[37m"; // White
            case WeatherType::Windy: return "\033[96m"; // Cyan
            case WeatherType::Hot: return "\033[91m"; // Red
            case WeatherType::Cold: return "\033[96m"; // Cyan
            case WeatherType::Magical_Storm: return "\033[92m"; // Green
        }
        return "\033[0m"; // Reset
    }
    ...
    std::string get_weather_symbol(WeatherType type) {
        switch (type) {
            ...
            case WeatherType::Partly_Cloudy: return "⛅";
            case WeatherType::Cloudy: return "☁";
            case WeatherType::Light_Rain: return "🌦";
            case WeatherType::Heavy_Rain: return "🌧";
            case WeatherType::Thunderstorm: return "⛈";
            case WeatherType::Light_Snow: return "🌨";
            case WeatherType::Heavy_Snow: return "❄";
            case WeatherType::Fog: return "🌫";
            case WeatherType::Windy: return "💨";
            case WeatherType::Hot: return "🔥";
            case WeatherType::Cold: return "🧊";
            case WeatherType::Magical_Storm: return "✨";
        }
        return "?";
    }
    ...
    WeatherEffects get_default_effects(WeatherType type, WeatherIntensity intensity) {
        ...
        switch (intensity) {
            ...
            case WeatherIntensity::Light: intensity_multiplier = 0.7f; break;
            case WeatherIntensity::Moderate: intensity_multiplier = 1.0f; break;
