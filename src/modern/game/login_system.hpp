/***************************************************************************
 *   File: src/modern/game/login_system.hpp            Part of FieryMUD *
...
public:
    ...
    // Callbacks
    void set_player_loaded_callback(PlayerLoadedCallback callback) { 
        player_loaded_callback_ = std::move(callback); 
    }
