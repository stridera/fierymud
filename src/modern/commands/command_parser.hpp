/***************************************************************************
 *   File: src/commands/command_parser.hpp                Part of FieryMUD *
 *  Usage: Modern command parsing and dispatch system                      *
 *                                                                         *
...
struct ParsedCommand {
    ...
    ParsedCommand(std::string_view cmd, std::vector<std::string> args = {})
...
public:
    ...
    std::vector<std::string> get_suggestions(std::string_view partial,
...
public:
    ...
    std::vector<std::string> complete_with_context(std::string_view partial,
                                                  std::shared_ptr<Actor> actor,
                                                  std::shared_ptr<Room> room) const;
    
    /** Clear completion database */
    void clear() { commands_.clear(); aliases_.clear(); }
    
private:
    std::vector<std::string> commands_;
    std::unordered_map<std::string, std::string> aliases_;  // alias -> command
    
    std::vector<std::string> get_context_objects(std::shared_ptr<Actor> actor,
                                                std::shared_ptr<Room> room) const;
};
